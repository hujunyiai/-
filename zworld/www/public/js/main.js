...
/*一个文件只能有一个模块*/
define(['jquery','app/indexnav','app/indexmenu','app/indexbanner','app/textsuggest','app/indexFreeWalk'],function($,nav,menu,banner,suggest,freewalk){
	/*顶部广告关闭*/
